...
<main class="page-main-hero">
    ...
    <section class="spaced-section">
        ...
        <p style="margin-top:0.75rem;">Besoin de vous organiser ? Vous pouvez <a href="rdv/rdv.php">prendre rendez-vous en ligne</a> et nous pouvons, dans certains cas, organiser le convoyage de votre véhicule.</p>
    </section>
